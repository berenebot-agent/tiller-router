...
- **Don't collect content you don't need** — Activity answers "what route did this request take?", not "what did it say?". Request and provider response bodies are never persisted in logs or exports.
