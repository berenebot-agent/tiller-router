...
''')
    ...
    for provider_name in ("tiller-chat", "tiller-responses", "tiller-messages"):
        result = subprocess.run(
            ["hermes", "--oneshot", "Return exactly hello", "--provider", provider_name, "--model", "main/coding", "--ignore-rules"],
            cwd=home,
            env=env,
            capture_output=True,
            text=True,
...
print("Hermes chat_completions, codex_responses, and anthropic_messages probes passed")
