...
function activityRequestID(row) { const id = row.client_request_id || ''; const short = id.length > 8 ? `${id.slice(0, 8)}…` : id; return `<code class="model-id activity-request-id" title="${h(id)}">${h(short)}</code>`; }
