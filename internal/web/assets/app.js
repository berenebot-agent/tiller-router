...
async function loadModels(search = $('#model-search').value) { const result = await api(`/api/admin/models?all=1&search=${encodeURIComponent(search || '')}`); state.models = result.data; renderModels(); }
